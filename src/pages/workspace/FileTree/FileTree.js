...
// function FileTree(props: { trees: any; rootFileName: any; }) {
// 	const [files, setFiles] = useState(props.trees);
// 	function makeTree(files: any[]) {
// 		const tree = { root: { title: props.rootFileName, children: {} } };
// 		files.forEach((file: { name: string; size: any; }) => {
// 			const path = file.name.split('/');
// 			let node = tree.root.children;
// 			path.forEach((folder: string | number) => {
// 				if (!node[folder]) {
// 					node[folder] = {
// 						title: folder,
// 						children: {},
...
// 		{
// 			title: props.rootFileName,
// 			children: makeTree(files).root.children,
// 		},
// 	]);
// 	return (
// 		<SortableTree
