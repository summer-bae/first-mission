...
router.post('/file/upload', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        (0, upload_1.upload)(req, res, function (err) {
            ...
            if ((filePath === null || filePath === void 0 ? void 0 : filePath.split('.')[1]) === 'zip') {
                const zip = new adm_zip_1.default(filePath);
                const target = '../upload/' + req.session.user.id;
                rimraf_1.default.sync(target);
                ...
                if (typeof filePath === 'string') {
                    const t = fs_1.default.createReadStream(filePath).pipe(tar_fs_1.default.extract(target, {
                        readable: true,
...
router.get('/file/contents', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contents = fs_1.default.readFileSync('../upload/' + req.session.user.id + '/' + req.query.filename, 'utf8');
        res.send(contents);
    }
    catch (err) {
        console.log(err);
...
router.post('/file/contents', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { filename, contents } = req.body;
        fs_1.default.writeFileSync('../upload/' + req.session.user.id + '/' + filename, contents, 'utf8');
        res.send(true);
    }
    catch (err) {
        console.error(err);
