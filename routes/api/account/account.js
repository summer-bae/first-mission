			...
			(0, upload_1.upload)(req, res, function (err) {
				...
				if (
					...
					if (typeof filePath === 'string') {
						const t = fs_1.default.createReadStream(filePath).pipe(
							tar_fs_1.default.extract(target, {
								readable: true,
...
router.get('/file/contents', (req, res, _next) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			const contents = fs_1.default.readFileSync(
				'./routes/api/upload/' +
					req.session.user.id +
					'/' +
					req.query.filename,
...
router.post('/file/contents', (req, res, _next) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
